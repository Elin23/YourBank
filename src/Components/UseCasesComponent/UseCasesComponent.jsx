...
export default function UseCasesComponent({ reverse }) {
  return (
    <>
      <div
        className={
          reverse ? "Af-UseCasesComponentReverse " : "Af-UseCasesComponent"
        }
      >
        <div
          className={
            reverse
              ? "Af-UseCasesComponentSide-1Reverse "
              : "Af-UseCasesComponentSide-1"
          }
        >
          <div className="Af-cardTop">
            <div className="Af-UseCasesComponentSide-1-card">
              <div className="Af-UseCasesComponentSide-1-card-img">
                <div>
                  {!reverse && (
                    <img src={UseCaseData[0].properities[0].icon} alt="" />
                  )}
                  {reverse && (
                    <img src={UseCaseData[1].properities[0].icon} alt="" />
                  )}
                </div>
              </div>
            ...
            <div className="Af-UseCasesComponentSide-1-card">
              <div className="Af-UseCasesComponentSide-1-card-img">
                <div>
                  {!reverse && (
                    <img src={UseCaseData[0].properities[1].icon} alt="" />
                  )}
                  {reverse && (
                    <img src={UseCaseData[1].properities[1].icon} alt="" />
                  )}
                </div>
              </div>
          ...
          <div className="Af-cardBottom">
            <div className="Af-UseCasesComponentSide-1-card">
              <div className="Af-UseCasesComponentSide-1-card-img">
                <div>
                  {!reverse && (
                    <img src={UseCaseData[0].properities[2].icon} alt="" />
                  )}
                  {reverse && (
                    <img src={UseCaseData[1].properities[2].icon} alt="" />
                  )}
                </div>
              </div>
            ...
            <div className="Af-UseCasesComponentSide-1-card">
              <div className="Af-UseCasesComponentSide-1-card-img">
                <div>
                  {!reverse && (
                    <img src={UseCaseData[0].properities[3].icon} alt="" />
                  )}
                  {reverse && (
                    <img src={UseCaseData[1].properities[3].icon} alt="" />
                  )}
                </div>
              </div>
        ...
        <div className="Af-UseCasesComponentSide-2">
          <div className="Af-UseCasesComponentSide-2-title">
            {!reverse && (
              <h4 className="fs-30">{UseCaseData[0].heading.title}</h4>
            )}
            {reverse && (
              <h4 className="fs-30">{UseCaseData[1].heading.title}</h4>
            )}
